...
import { withConfiguration, Table, Flex, Button } from '@pega/cosmos-react-core';
import { AppAnnouncement as PegaAppAnnouncement } from '@pega/cosmos-react-work';
import type { PConnFieldProps } from './PConnProps';

import StyledAreteansExtensionsPageActionsWrapper from './styles';

// interface for props
interface AreteansExtensionsPageActionsProps extends PConnFieldProps {
...
function AreteansExtensionsPageActions(props: AreteansExtensionsPageActionsProps) {
  const {
    header,
    description,
    datasource = [],
  ...
  return (
    <StyledAreteansExtensionsPageActionsWrapper>
      {/* <PegaAppAnnouncement
        heading={header}
      ...
      <Flex container={{ direction: 'row' }}>
        <Button>{btn_label1}</Button>
        <Button>{btn_label2}</Button>
      </Flex>
    </StyledAreteansExtensionsPageActionsWrapper>
  );
}

export default withConfiguration(AreteansExtensionsPageActions);
