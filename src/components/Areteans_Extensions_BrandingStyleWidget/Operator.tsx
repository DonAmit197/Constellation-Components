...
// interface for props
interface AreteansExtensionsBrandingStyleWidgetOperatorProps extends PConnFieldProps {
...
function Operator(props: AreteansExtensionsBrandingStyleWidgetOperatorProps) {
