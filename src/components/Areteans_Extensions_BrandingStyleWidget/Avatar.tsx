...
// interface for props
interface AreteansExtensionsBrandingStyleWidgetAvatarProps extends PConnFieldProps {
...
function Avatar(props: AreteansExtensionsBrandingStyleWidgetAvatarProps) {
